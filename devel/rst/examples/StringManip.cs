...
/** problem for class -- significant logical sequence */
class StringManip
{
    static void Main ()
    {
        ...
        Console.WriteLine("str3 = str1 - best to worst: " + str3);
        string str4 = replaceFirst(str2, "best", "worse");
        Console.WriteLine("str2 - best to worst: " + str4);
        string str5 = replaceFirst(str3, "worse", "best");
        Console.WriteLine("str3 - worst to best: " + str5);
    }
